<footer class="bg-purple-800 w-full">
  <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
    <!-- Grid -->
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
      <div class="col-span-full lg:col-span-1">
        <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="Brand">GroceryGenie</a>
      </div>
      <!-- End Col -->

      <div class="col-span-1">
        <h4 class="font-semibold text-gray-100">Supermarkets</h4>

        <div class="mt-3 grid space-y-3">
          <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="/supermarkets">Supermarkets</a></p>
          <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="/genie/login">Genie Login</a></p>
          <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="/orders">Orders</a></p>
        </div>
      </div>
      <!-- End Col -->
      ...
      <div class="col-span-1">
        ...
        <div class="mt-3 grid space-y-3">
          ...
          <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="/user/profile">Profile</a></p>

          <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="/contact">Contact Us</a></p>
        </div>
      </div>
      <!-- End Col -->
    ...
    <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
      <div class="flex justify-between items-center">
        <p class="text-sm text-gray-400">© 2024 GroceryGenie. All rights reserved.</p>
      </div>
      <!-- End Col -->
